                        ...
                        <el-form :model="form" label-width="80px" label-position="left" style="width: 100%">
                            ...
                            <div v-if="advanced === '2'">
                                <el-form-item label="后端地址:">
                                    <el-autocomplete style="width: 100%" v-model="form.customBackend"
                                        :fetch-suggestions="backendSearch" placeholder="请选择或填入后端地址">
                                ...
                                <el-form-item label="FileName:">
                                    <el-input v-model="form.filename"
                                        placeholder="返回的订阅文件名(填写后Content-Disposition字段将被设为attachment)" />
                                </el-form-item>
                            ...
                            <el-form-item label-width="0px" style="margin-top: 40px; text-align: center">
                                <el-button plain style="width: 30%" type="danger" @click="copyUrl"
                                    :disabled="form.sourceSubUrl.length === 0">复制订阅链接</el-button>
                            ...
                            <el-form-item label-width="0px" style="text-align: center">
                                ...
                                <el-button plain style="width: 15%" type="danger" @click="gotoController"
                                    icon="el-icon-link">进入控制器</el-button>
                            </el-form-item>
                        </el-form>
                    </el-container>
                </el-card>
    ...
    data() {
        return {
            ...
            options: {
                ...
                backendOptions: [
                    { value: "https://sub.datagrids.dev/sub?" },
                ...
                remoteConfig: [
                    {
                        ...
                        label: "shevon维护的ACL4SSR（带学术网站分流和更友好的规则）",
                        options: [
                            {
                                label: "ACL4SSR_shevon 即时更新魔改版，适配最新网络环境(极力推荐使用)",
                                value: "https://raw.githubusercontent.com/ShevonKuan/ACL4SSR/main/Clash/config/ACL4SSR_shevon.ini"
                            },
                            {
                                label: "ACL4SSR_Online 默认版 分组比较全(与Github同步)",
                                value: "https://raw.githubusercontent.com/ShevonKuan/ACL4SSR/main/Clash/config/ACL4SSR_Online.ini"
                            }, {
                                label: "ACL4SSR_Online_AdblockPlus 更多去广告(与Github同步)",
                                value: "https://raw.githubusercontent.com/ShevonKuan/ACL4SSR/main/Clash/config/ACL4SSR_Online_AdblockPlus.ini"
                            }, {
                                label: "ACL4SSR_Online_NoAuto 无自动测速(与Github同步)",
                                value: "https://raw.githubusercontent.com/ShevonKuan/ACL4SSR/main/Clash/config/ACL4SSR_Online_NoAuto.ini"
                            }, {
                                label: "ACL4SSR_Online_NoReject 无广告拦截规则(与Github同步)",
                                value: "https://raw.githubusercontent.com/ShevonKuan/ACL4SSR/main/Clash/config/ACL4SSR_Online_NoReject.ini"
                            }, {
                                label: "ACL4SSR_Online_Mini 精简版(与Github同步)",
                                value: "https://raw.githubusercontent.com/ShevonKuan/ACL4SSR/main/Clash/config/ACL4SSR_Online_Mini.ini"
                            }, {
                                label: "ACL4SSR_Online_Mini_AdblockPlus.ini 精简版 更多去广告(与Github同步)",
                                value: "https://raw.githubusercontent.com/ShevonKuan/ACL4SSR/main/Clash/config/ACL4SSR_Online_Mini_AdblockPlus.ini"
                            }, {
                                label: "ACL4SSR_Online_Mini_NoAuto.ini 精简版 不带自动测速(与Github同步)",
                                value: "https://raw.githubusercontent.com/ShevonKuan/ACL4SSR/main/Clash/config/ACL4SSR_Online_Mini_NoAuto.ini"
                            }, {
                                label: "ACL4SSR_Online_Mini_Fallback.ini 精简版 带故障转移(与Github同步)",
                                value: "https://raw.githubusercontent.com/ShevonKuan/ACL4SSR/main/Clash/config/ACL4SSR_Online_Mini_Fallback.ini"
                            }, {
                                label: "ACL4SSR_Online_Mini_MultiMode.ini 精简版 自动测速、故障转移、负载均衡(与Github同步)",
                                value: "https://raw.githubusercontent.com/ShevonKuan/ACL4SSR/main/Clash/config/ACL4SSR_Online_Mini_MultiMode.ini"
                            }, {
                                label: "ACL4SSR_Online_Mini_MultiCountry.ini 精简版 带港美日国家(与Github同步)",
                                value: "https://raw.githubusercontent.com/ShevonKuan/ACL4SSR/main/Clash/config/ACL4SSR_Online_Mini_MultiCountry.ini"
                            }, {
                                label: "ACL4SSR_Online_Full 全分组 重度用户使用(与Github同步)",
                                value: "https://raw.githubusercontent.com/ShevonKuan/ACL4SSR/main/Clash/config/ACL4SSR_Online_Full.ini"
                            }, {
                                label: "ACL4SSR_Online_Full_MultiMode.ini 全分组 多模式 重度用户使用(与Github同步)",
                                value: "https://raw.githubusercontent.com/ShevonKuan/ACL4SSR/main/Clash/config/ACL4SSR_Online_Full_MultiMode.ini"
                            }, {
                                label: "ACL4SSR_Online_Full_NoAuto.ini 全分组 无自动测速 重度用户使用(与Github同步)",
                                value: "https://raw.githubusercontent.com/ShevonKuan/ACL4SSR/main/Clash/config/ACL4SSR_Online_Full_NoAuto.ini"
                            }, {
                                label: "ACL4SSR_Online_Full_AdblockPlus 全分组 重度用户使用 更多去广告(与Github同步)",
                                value: "https://raw.githubusercontent.com/ShevonKuan/ACL4SSR/main/Clash/config/ACL4SSR_Online_Full_AdblockPlus.ini"
                            }, {
                                label: "ACL4SSR_Online_Full_Netflix 全分组 重度用户使用 奈飞全量(与Github同步)",
                                value: "https://raw.githubusercontent.com/ShevonKuan/ACL4SSR/main/Clash/config/ACL4SSR_Online_Full_Netflix.ini"
                            }, {
                                label: "ACL4SSR_Online_Full_Google 全分组 重度用户使用 谷歌全量(与Github同步)",
                                value: "https://raw.githubusercontent.com/ShevonKuan/ACL4SSR/main/Clash/config/ACL4SSR_Online_Full_Google.ini"
                            }, {
